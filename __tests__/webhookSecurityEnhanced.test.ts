...
describe("Enhanced Webhook Security", () => {
  ...
  describe("Enhanced Signature Validation", () => {
    ...
    it("should reject signatures with wrong length for algorithm", () => {
      const payload = JSON.stringify({ test: "data" });
    ...
    it("should handle Stripe signature format with validation", () => {
      const payload = JSON.stringify({ test: "data" });
    ...
    it("should handle GitHub signature format with validation", () => {
      const payload = JSON.stringify({ test: "data" });
      const signature = crypto.createHmac("sha256", testSecret).update(payload).digest("hex");
  ...
  describe("Enhanced Timestamp Validation", () => {
    ...
    it("should reject invalid tolerance values", () => {
    ...
    it("should validate reasonable timestamps within tolerance", () => {
      const currentTimestamp = Math.floor(Date.now() / 1000);
  ...
  describe("Enhanced Payload Sanitization", () => {
    ...
    it("should handle invalid numbers safely", () => {
      const payload = {
        validNumber: 42,
        invalidNumber: NaN,
    ...
    it("should limit object key count to prevent DoS", () => {
    ...
    it("should remove function objects", () => {
      const payload = {
        normalData: "safe",
    ...
    it("should sanitize object keys properly", () => {
      const payload = {
        normal_key: "value1",
    ...
    it("should handle deeply nested objects with circular references", () => {
      const payload: Record<string, unknown> = { level1: { level2: { level3: "deep" } } };
  ...
  describe("Enhanced Security Checks", () => {
    it("should detect suspicious proxy headers", async () => {
      const payload = JSON.stringify({ test: "data" });
    ...
    it("should validate content type strictly", async () => {
      const payload = JSON.stringify({ test: "data" });
      const signature = validator.generateSignature(payload, testSecret);
  ...
  describe("Provider-Specific Validation", () => {
    ...
    it("should validate Stripe webhook structure", async () => {
    ...
    it("should validate Clerk webhook structure", async () => {
  ...
  describe("Comprehensive Webhook Validation", () => {
    ...
    it("should handle payload that is too large", async () => {
    ...
    it("should validate with all security checks enabled", async () => {
      const validPayload = {
        id: "evt_test_123",
        object: "event",
        type: "test.event",
    ...
    it("should log performance warnings for slow validation", async () => {
      const consoleSpy = jest.spyOn(console, "warn").mockImplementation();
  ...
  describe("Integration with Middleware", () => {
    it("should properly integrate with webhook security middleware", async () => {
    ...
    it("should reject invalid webhooks in middleware", async () => {
      ...
      const { webhookValidator } = require("../server/lib/webhookValidator");
