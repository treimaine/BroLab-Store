...
console.log("Expected monthly orders:", monthlyOrders);
console.log("Stats monthly orders:", data.stats.monthlyOrders);
console.log("Expected monthly downloads:", monthlyDownloads);
console.log("Stats monthly downloads:", data.stats.monthlyDownloads);
...
result.inconsistencies.forEach((inc, i) => {
  console.log(`${i + 1}. ${inc.severity} - ${inc.description}`);
});
