...
export const trackAddToCart = (productId: string, productName: string, price: number, licenseType?: string) => {
  track('add_to_cart', {
...
export const trackSubscriptionCheckoutStarted = (planId: string, planName: string, billingInterval: 'monthly' | 'annual', price: number) => {
...
export const trackAudioAction = (action: 'play' | 'pause' | 'seek' | 'volume_change', productId: string, currentTime?: number) => {
  track('audio_action', {
    action,
    product_id: productId,
