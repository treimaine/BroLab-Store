                ...
                <div className="space-y-2">
                  ...
                  {filteredProducts.map((product: any) => {
                    ...
                    return (
                      <div
                        key={product.id}
                        className="grid grid-cols-12 gap-4 items-center px-4 py-4 bg-gray-800/20 hover:bg-gray-800/40 rounded-lg transition-colors group"
                      >
                        {/* Thumbnail & Title */}
                        ...
                        <div className="col-span-4">
                          ...
                          <p className="text-gray-400 text-xs mt-1">
                            Beats, Drum, Heavy Bass, Pipe... Energetic, In...
                          </p>
                        </div>
