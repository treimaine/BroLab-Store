...
export default function Cart() {
  const { cart, updateQuantity, removeItem, updateLicense, refreshCartPricing, clearCart } = useCartContext();
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-4">
                      <Select
                        ...
                        onValueChange={(value) => updateLicense(item.beatId, item.licenseType, value as LicenseTypeEnum)}
                      >
                        <SelectTrigger className="w-48 form-input text-sm">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="basic">Basic License - ${LicensePricing.basic}</SelectItem>
                          <SelectItem value="premium">Premium License - ${LicensePricing.premium}</SelectItem>
                          <SelectItem value="unlimited">Unlimited License - ${LicensePricing.unlimited}</SelectItem>
                        </SelectContent>
                      </Select>
