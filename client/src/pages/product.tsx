...
import { ArrowLeft, Heart, Music, ShoppingCart, Info, FileText } from 'lucide-react';
      ...
      <div className="pt-16 bg-[var(--dark-gray)] min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-6">The beat you're looking for doesn't exist or may have been removed.</p>
          ...
          <div className="space-y-6">
            ...
            {!isFree && (
              <div className="card-dark p-6">
                ...
                <RadioGroup value={selectedLicense} onValueChange={(value: string) => setSelectedLicense(value as "basic" | "premium" | "unlimited")}>
                  <div className="space-y-3">
                    {licenseOptions.map((option) => (
                      <div key={option.type} className="flex items-center space-x-3 p-4 bg-[var(--dark-gray)] rounded-lg cursor-pointer hover:bg-gray-700 transition-colors">
