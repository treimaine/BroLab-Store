import { Crown, Download, Clock, Zap, Star, Shield } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
          {perks.map((perk, index) => {
            ...
            return (
              <Card key={index} className="bg-[var(--medium-gray)]/50 border-[var(--accent-purple)]/30 backdrop-blur-sm">
        ...
        <div className="text-center">
          <div className="mb-6">
            <Badge className="bg-[var(--color-gold)] text-black text-lg px-4 py-2 mb-4">
              Limited Time: Save 17% with Annual Plans
            </Badge>
          </div>
