...
import { FileText, Download, Shield, Users, Music } from 'lucide-react';
...
export function LicensePreviewModal({ 
  ...
  const licenseDetails: Record<string, LicenseDetails> = {
    ...
    premium: {
      ...
      description: '[Most Popular] If you want the highest quality audio file + streaming license this is for you!',
      price: 49.99,
      icon: Shield,
      features: [
        'MP3 + WAV included',
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <DialogContent className="max-w-4xl bg-[var(--medium-gray)] border-[var(--accent-purple)]/30 max-h-[90vh]">
        <DialogHeader>
          <DialogTitle className="text-2xl text-white flex items-center gap-3">
            <Icon className="w-6 h-6 text-[var(--accent-purple)]" />
            {license.name} Agreement
          </DialogTitle>
        </DialogHeader>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[var(--dark-gray)] p-6 rounded-lg border border-[var(--accent-purple)]/20">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-right">
                  ...
                  <Badge className={`${license.commercialUse ? 'bg-[var(--accent-green)]' : 'bg-yellow-600'}`}>
            ...
            <div>
              ...
              <div className="bg-[var(--dark-gray)] p-4 rounded-lg text-sm text-gray-300 space-y-3">
                <p>
                  <strong className="text-white">Grant of License:</strong> This license grants you the non-exclusive right to use the musical composition "{beatTitle}" produced by {producer} under the {license.name} terms specified above.
                </p>
                <p>
                  <strong className="text-white">Usage Rights:</strong> {license.commercialUse ? 'Full commercial usage permitted including monetization, sales, and distribution.' : 'Non-commercial use only. No monetization or commercial distribution permitted.'}
                </p>
                <p>
                  <strong className="text-white">Credit Requirements:</strong> {license.creditRequired ? 'Producer credit "Prod. by BroLab Entertainment" must be included in all releases and metadata.' : 'Producer credit is optional but appreciated.'}
                </p>
                <p>
                  <strong className="text-white">Distribution Limit:</strong> {license.distributionLimit} permitted under this license.
                </p>
                <p>
                  <strong className="text-white">Territory:</strong> Worldwide usage permitted in all territories and platforms.
                </p>
                <p className="text-xs text-gray-400 pt-2 border-t border-gray-600">
                  * This is a summary. Complete licensing agreement with full terms and conditions will be provided upon purchase. License becomes effective immediately upon payment confirmation.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between pt-4 border-t border-[var(--medium-gray)]">
          <div className="text-sm text-gray-400">
            Questions? <Button variant="link" className="p-0 h-auto text-[var(--accent-purple)]">Contact Support</Button>
          </div>
