...
import { ArrowRight, Headphones, Mic, Music, Settings, Star } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Beyond beats, we offer comprehensive music production services to help you create
        ...
        <div className="text-center bg-gradient-to-r from-[var(--accent-purple)]/10 to-[var(--accent-cyan)]/10 border border-[var(--accent-purple)]/20 rounded-2xl p-8">
          ...
          <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
            Can&apos;t find exactly what you&apos;re looking for? Get in touch and we&apos;ll create
