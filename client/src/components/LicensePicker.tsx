...
export function LicensePicker({ 
  ...
  if (licenses.length === 0) {
    return (
      <div className={`bg-[var(--dark-gray)] border border-[var(--medium-gray)] rounded-xl p-6 ${className}`}>
          ...
          <div
            ...
            className={`relative border rounded-lg p-4 cursor-pointer transition-all duration-200 ${
              selectedLicenseId === license.id
                ...
                ? 'border-[var(--accent-purple)]/50 bg-[var(--deep-black)]'
                : 'border-[var(--medium-gray)] bg-[var(--deep-black)]'
            }`}
