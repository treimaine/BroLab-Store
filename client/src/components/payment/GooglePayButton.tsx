...
export const GooglePayButton: React.FC<GooglePayButtonProps> = ({ amount, onSuccess, onError }) => {
        ...
        allowedPaymentMethods: [
          {
            ...
            tokenizationSpecification: {
              ...
              parameters: {
                gateway: "clerk", // Using Clerk for payment processing
      "clerk:version": "2024-01-01"
              },
            },
          },
        ],
