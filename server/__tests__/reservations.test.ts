...
import { ServiceType, ReservationStatus } from '../../shared/schema';
...
describe('Reservation System', () => {
  const mockReservation = {
    ...
    details: { track_name: 'Test Track', genre: 'Hip-Hop' },
  ...
  describe('updateReservationStatus', () => {
    ...
    it('should throw error for non-existent reservation', async () => {
      await expect(storage.updateReservationStatus('non-existent-id', 'confirmed'))
