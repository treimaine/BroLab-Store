...
router.get("/verify-email", validateRequest(verifyEmailSchema), async (req, res): Promise<void> => {
  try {
...
router.post("/resend-verification", validateRequest(resendVerificationSchema), async (req, res): Promise<void> => {
  try {
...
router.post("/forgot-password", validateRequest(forgotPasswordSchema), async (req, res): Promise<void> => {
  try {
    const { email } = req.validatedData;
...
router.post("/reset-password", validateRequest(resetPasswordSchema), async (req, res): Promise<void> => {
  try {
